...
export default function Navigation({ 
  ...
  const publicItems = [
    ...
    { id: "absensi", name: "Absensi", icon: CheckCircle2 },
    { id: "kkn-workspace", name: "KKN Workspace", icon: Layers },
    { id: "team-quotes", name: language === "en" ? "Team Quotes" : "Suara Tim", icon: Users },
    { id: "gallery", name: language === "en" ? "Gallery" : "Galeri", icon: Camera },
    { id: "about-project", name: "About Project", icon: Award }
  ];
