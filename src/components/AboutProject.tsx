                ...
                <div className="relative rounded-3xl bg-gradient-to-b from-[#090b16]/95 to-[#04050a]/98 border border-white/10 p-6.5 shadow-[12px_12px_36px_rgba(0,0,0,0.95)] overflow-hidden text-left flex flex-col justify-between">
                  <div>
                    <h4 className="font-mono text-[10.5px] font-black text-slate-300 uppercase tracking-widest flex items-center space-x-2 pb-3 border-b border-white/5 mb-4">
                      ...
                      <span>{t("about.contact_title", "ADMINISTRATOR CONNECT")}</span>
                    </h4>
                    <p className="text-xs text-slate-400 leading-relaxed mb-5.5 font-medium">
                      {t("about.contact_desc", "Connect directly with the KKN Project Administrator for coordination, reporting, and general inquiries:")}
                    </p>
                  </div>

                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3" id="developer_contact_channels">
                    {/* WhatsApp */}
                    <a
                      href={`https://wa.me/6281220010205?text=${encodeURIComponent(
                        language === "en"
                          ? "Hello *KKN Project Administrator*, I hope you are doing well.\n\nI am reaching out regarding the *KKN Project Digital Workspace*. I would like to inquire further about program reports, attendance coordination, or workspace resources.\n\nThank you very much."
                          : "Halo *Admin KKN Persyarikatan 063*, salam hangat.\n\nSaya menghubungi Anda mengenai platform *KKN Project Digital Workspace*.\nSaya ingin berkoordinasi lebih lanjut mengenai:\n- _Laporan & Program Kerja_\n- _Presensi & Kehadiran Kelompok_\n- _Administrasi Keuangan & Transaksi_\n\nMohon arahan dan bimbingannya untuk kelancaran kegiatan KKN kami. Terima kasih banyak."
                      )}`}
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="p-3 rounded-2xl bg-[#030409]/85 border border-cyan-500/20 hover:border-cyan-500/50 hover:bg-cyan-500/10 flex flex-col items-center justify-center text-[#25f4ee] transition-all duration-300 text-center gap-1.5 cursor-pointer hover:-translate-y-[2px] shadow-[4px_4px_12px_rgba(0,0,0,0.5)]"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" id="Layer_2" viewBox="0 0 352.28 398.67" className="w-5 h-5">
                        <defs><style>{`.cls-2-tk{fill:#fe2c55}.cls-3-tk{fill:#25f4ee}`}</style></defs>
                        <g id="Layer_1-2">
                      ...
                      <span className="font-mono text-[8px] font-black tracking-widest uppercase">TikTok</span>
                    </a>
                  </div>
                </div>
